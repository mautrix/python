...
* Added `file_name` parameter to `HTTPAPI.get_download_url`.

## v0.15.6 (2022-03-30)

* Fixed removing nested (i.e. malformed) reply fallbacks generated by
  some clients.
* Added automatic reply fallback trimming to `set_reply()` to prevent
  accidentally creating nested reply fallbacks.

## v0.15.5 (2022-03-28)

* Changed default behavior of OlmMachine to ignore instead of reject
